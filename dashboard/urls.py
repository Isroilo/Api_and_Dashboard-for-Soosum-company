...
urlpatterns = [
    ...
    path('search-order/', search_order, name='search_order_url'),
    ...
    path('order/', order_view, name='order_url'),
    ...
    path('about-company/', about_company_view, name='about_company_url'),
    ...
    path('instruction/', instruction_view, name='instruction_url'),
    ...
    path("fact-title/", fact_view, name='fact_url'),
    ...
    path('info/', info_view, name='info_url'),
